...
exports.findById = exports.update = exports.passwordCheck = exports.findOneAndUpdate = exports.findOne = exports.create = void 0;
...
let update = function (query, data, options = null) {
    return new Promise(function (resolve, reject) {
...
let findById = function (userId) {
    return new Promise(function (resolve, reject) {
        user_model_1.default.findById(userId, select)
            .then((user) => {
            if (user) {
                resolve(user);
            }
